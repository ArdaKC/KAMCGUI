...
class Ui_Form(object):
                     ...
                     try:
                         with open("agcihazi.txt", "r") as f:
                             ...
                             if agcihazi == "":
                                 ...
                                 if os.system(
                                         "sudo ifconfig " + agcihazi + " down && sudo service NetworkManager stop && sudo macchanger -r " + agcihazi + " && sudo ifconfig " + agcihazi + " up && sudo service NetworkManager start") == 0:
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "KCS AutoMacchanger 2021.2.0-^"))
